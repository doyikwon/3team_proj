...
def render_virtual_pillbox_page():
    ...
    if os.path.exists(html_path):
        ...
        st.error("가상 약통 HTML 파일(html_app/virtual_pillbox.html)을 찾을 수 없습니다.")
...
if hasattr(st, "navigation") and hasattr(st, "Page"):
    ...
    page_3 = st.Page(render_virtual_pillbox_page, title="가상 약통", icon="💊")
    ...
    menu = st.sidebar.radio("메뉴 이동", ["맞춤 진단", "가상 약통", "데이터 분석"])
